...
1. Apóyese del siguiente circuito, colocando una resistencia y un diodo led en seria a una de las terminales del Nodemcu ESP32 de tal forma que puede general una señal digital.
...
Simulacion
![imagen](IMG/C4.1_simulacion.png)
Se aplicó la misma idea que con el bluetooth, escribo 1 y se enciende escribo 2 y se apaga.

Circuito elaborado por Alexis Gonzales

![imagen](IMG/C4.1_e1.png)
![imagen](IMG/C4.1_e2.png)
![imagen](IMG/C4.1_e3.png)

![imagen](IMG/C4.1_e5.jpg)
![imagen](IMG/C4.1_e6.jpg)
![imagen](IMG/C4.1_e7.jpg)
![imagen](IMG/C4.1_e8.jpg)
