...
En el circuito se pude observar como el potenciometro varia de resistencia, esto permitiendo que el led varie el delay o intervalo de encendido y apago, el cual se puede ver en el codigo que el valor del sensor es el delay.

![evidencia](IMG/C3.4_evidencia.PNG)
### :bomb: Rubrica
