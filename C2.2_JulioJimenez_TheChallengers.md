...
Se conecta a la fila de reles para controlar las electrovalvulas.
...
-motores: mueve y controla en los 3 ejes par a la impresion

-ventilador y dicipador de calor :para evitar y controlar el sobrecalentamiento

-extursor:se introduce y expulsa para imprimir
