...
1. Utilice el siguiente listado de modelos de sensores comerciales para elaborar su actividad:
   ...
   - [x] 1.5 Sensor Temperatura y humedad [DHT22](https://articulo.mercadolibre.com.mx/MLM-761350149-sensor-de-temperatura-y-humedad-dht22-arduino-_JM?quantity=1#position=1&type=item&tracking_id=509ff3d0-c091-4fbc-8ff5-63ff0c0adaec)
...
[presentacion/documento](https://github.com/JJimenez2117/SistemasProg/blob/master/A1.3_TheChallengers.pdf)
   
- **Conclusiones** por cada uno de los integrantes del equipo.

Julio Jiménez: 
En conclusión, esta práctica se pudo conocer y analizar las características  del sensor DHT22, su estructura y funcionamiento, al igual que sus usos aplicativos. El cual nos permite monitorear y convertir los valores de temperatura y humedad en un valor digital. 

Jorge Diaz:
Con la realización de esta práctica podemos darnos cuenta de las características que presenta y el funcionamiento que maneja el sensor DHT22 lo que lo hace bastante útil ya que permite monitorear temperatura y humedad lo que permite que sea usado para monitoreo ambiental de forma precisa.


Alexis Gonzalez:
El sensor DHT22 es muy útil si de monitorear estamos hablando, ya que es muy útil el que pueda medir la temperatura y humedad del ambiente donde se encuentra instalado y lo hace de una manera bastante precisa.
...
![imagen](IMG/A1.3_evidenciaalexis.PNG)

![imagen](IMG/A1.3_evidenciajulio.PNG)

![imagen](IMG/A1.3_evidenciajorge.PNG)
___
