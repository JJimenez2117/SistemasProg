...
1. Inserte imágenes que considere como evidencias para demostrar el resultado obtenido.
<p align="center">
    <img alt="evidencia" src="IMG/C3.2_evidencia.png" width=550 height=400>
</p>

4. Observado
   
   El circutio utiliza el boton para generar un input y se imprime el estado del boton, ya sea encendido o apagado
