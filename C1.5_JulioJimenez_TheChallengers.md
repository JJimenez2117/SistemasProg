...
1. Dada la siguiente tabla responda mínimo tres tipos de sensores que se podrían utilizar en función a la variable a medir en cada aplicación
    ...
    ---------|----------|
    Temperatura | Termistores, RTD(Resitence Temperature Detector), Termopares|
    Presencia | Mangnéticos, infrarrojos, ultrasonido|
    Distancia |infrarrojos, ultrasonido, sensores de distancia por cable |
    Presión | piezoelectricos, resistivos, barómetros|
    Iluminación | Fotorresistivos, fotoelectricos,Sensores de microondas|
...
2. Investigue en caso de considerlo, sobre que tipo de sensores pueden ser utilizados para las siguientes condiciones:
 ...
 piezoelectrico
  ...
  Potenciometro lineal o infrarrojo
